    ...
    class Program
    {
        ...
        Tutorial:
            if (Setup.firsttime == true)
            {
                ...
                Console.Title = "RebootedRec Intro";
                Console.WriteLine("Welcome to RebootedRec " + appversion + "!");
                Console.WriteLine("Is this your first time using RebootedRec?");
                Console.WriteLine("Yes or No (Y, N)");
                string readline22 = Console.ReadLine();
                if (readline22 == "y" || readline22 == "Y")
                {
                    Console.Clear();
                    Console.Title = "RebootedRec Tutorial";
                    Console.WriteLine("In that case, welcome to RebootedRec!");
                    Console.WriteLine("RebootedRec is server software that emulates the old servers of previous RecRoom versions.");
                    Console.WriteLine("To use RebootedRec, you'll need to have builds aswell!");
                    ...
                    Console.WriteLine(new WebClient().DownloadString("https://raw.githubusercontent.com/pirzthia-hash/RebootedRec/master/Update/builds.txt"));
        ...
        Start:
            Console.Title = "RebootedRec Startup Menu";
            Console.ForegroundColor = ConsoleColor.Green;
            Console.WriteLine("RebootedRec - Open source Old RecRoom server software. (Version: " + appversion + ")");
            Console.WriteLine("Made and provided by pirzthia-hash.");
            Console.WriteLine("Download source code here: https://github.com/pirzthia-hash/RebootedRec");
            Console.WriteLine("Discord: coming soon" + Environment.NewLine);
            if (!(new WebClient().DownloadString("https://raw.githubusercontent.com/pirzthia-hash/RebootedRec/master/Download/version.txt").Contains(appversion)))
            {
                Console.WriteLine("This version of RebootedRec is outdated. We recommend you install the latest version, RebootedRec " + new WebClient().DownloadString("https://raw.githubusercontent.com/pirzthia-hash/RebootedRec/master/Download/version.txt"));
            }
            ...
            if (readline == "1")
            {
                Console.Title = "RebootedRec Changelog";
                Console.Clear();
                Console.WriteLine(new WebClient().DownloadString("https://raw.githubusercontent.com/pirzthia-hash/RebootedRec/master/Download/changelog.txt"));
            ...
            if (readline == "2")
            {
                ...
                Settings:
                Console.Title = "RebootedRec Settings Menu";
                ...
                {
                    Console.Title = "RebootedRec Custom Room Downloader";
                    Console.Clear();
            ...
            Profile:
                Console.Title = "RebootedRec Profile Menu";
                ...
                else if (readline3 == "2")
                {
                    ...
                    else if (readline4 == "2")
                    {
                        ...
                        {
                            Console.Clear();
                            Console.WriteLine("Invalid Image (Make sure its on the same drive as RebootedRec)");
                            goto Profile;
                        }
                        Console.Clear();
                        Console.WriteLine("Success!");
                ...
                {
                    Console.Title = "RebootedRec Profile Downloader";
                    Console.Clear();
                    Console.WriteLine("Profile Downloader: This tool takes the username and profile image of any username you type in and imports it to RebootedRec.");
            ...
            if (readline == "4")
            {
                Console.Title = "RebootedRec Build Downloads";
                Console.Clear();
                Console.WriteLine("To download builds, either go to the builds channel or use the links below: (these links are also available from the #builds channel)" + Environment.NewLine);
                Console.WriteLine(new WebClient().DownloadString("https://raw.githubusercontent.com/pirzthia-hash/RebootedRec/master/Update/builds.txt"));
                Console.WriteLine("Download a build and press any key to continue:");
            ...
            if (readline == "5")
            {
                ...
                {
                    Console.Title = "RebootedRec October 19th 2017";
                    version = "2017";
                    Console.Clear();
                ...
                else if (readline2 == "2018")
                {
                    ...
                    {
                        Console.Title = "RebootedRec May 30th 2018";
                        version = "2018";
                        Console.Clear();
                    ...
                    {
                        Console.Title = "RebootedRec September 27th 2018";
                        version = "2018";
                        Console.Clear();
                    ...
                    {
                        Console.Title = "RebootedRec July 20th 2018";
                        version = "2018";
                        Console.Clear();
